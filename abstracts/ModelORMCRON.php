...
//require_once MSG_PATH . "Modules/Mail/lib/Configcron.php";

use Modules\Mail\lib\Configcron;
use Exception;
use stdClass;
...
abstract class ModelORMCRON
{
    ...
    protected function __construct( stdClass $properties  =   null ) {
        ...
        $provider = 'lib\database\\' . Configcron::$_DATABASE_;
